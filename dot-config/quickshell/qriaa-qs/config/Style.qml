...
Singleton {
    ...
    color: QtObject {
        ...
        sys: QtObject {
            property color surfaceLowest: root.color.ref.neutral5
            property color surfaceLow: root.color.ref.neutral10
            property color surface: root.color.ref.neutral15
            property color surfaceHigh: root.color.ref.neutral20
            property color surfaceHighest: root.color.ref.neutral25
            property color onsurface: root.color.ref.white

            property color outline: root.color.ref.neutral40
        }
